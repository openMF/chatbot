...
class ActionGetLoanStatus(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
            ...
            domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        loan_status = "ACTIVE"
        tracker.slots['loan_status'] = loan_status

        dispatcher.utter_message(text=f"Your loan status is {loan_status}")
...
class ActionHelloWorld(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        dispatcher.utter_message(text="Hello Meghna!")
